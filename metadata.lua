...
--- Plugin homepage
PLUGIN.homepage = "https://github.com/tinygo-org/tinygo"
--- Plugin license, please choose a correct license according to your needs.
PLUGIN.license = "Apache-2.0"
--- Plugin description
PLUGIN.description = "TinyGo plugin (https://tinygo.org/)"
...
NOTE:
 ...
 --]]
PLUGIN.manifestUrl = "https://github.com/izdatyi/vfox-tinygo/releases/download/manifest/manifest.json"
